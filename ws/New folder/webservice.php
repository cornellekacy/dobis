	...
	if(
	  ...
	  $param4 = mysqlquote(base64_encode(file_get_contents($_FILES['upload']['tmp_name'])));
		$param5 = mysqlquote($_POST['publisher']);
		$param6 = mysqlquote($_POST['category']);

		$params = $param1 . ", " .$param2. ", " .$param3. ", " .$param4. ", " .$param5. ", " .$param6;

	}else if($op == "Userphotoedit"){
			$param1 = mysqlquote($_POST['username']);
			$param2 = mysqlquote(base64_encode(file_get_contents($_FILES['fileinput']['tmp_name'])));
			$params = $param1. ", ".$param2;
	...
	if($res){
		...
		if($op == "loginUser"){
			$_SESSION["user_details"] = $output[0];
		}else if($op == "getRole"){
			$_SESSION["user_roles"] = $output[0];
		}
